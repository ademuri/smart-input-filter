...
TEST(MedianFilter, loading_in_order) {
  MedianFilter<uint32_t, uint32_t, 5> input(analog_read_function);
...
TEST(MedianFilter, steady_state_impulse) {
  ...
  std::vector<InputOutput<uint32_t, uint32_t>> data = {
      ...
      {200, 1, 200},  {100, 2, 200}, {100, 10, 100},
  };
  RunDataTest(&input, data, setAnalogRead);
}
...
TEST(MedianFilter, size_2) {
  MedianFilter<uint32_t, uint32_t, 2> input(analog_read_function);
  std::vector<InputOutput<uint32_t, uint32_t>> data = {
      {100, 1, 100},
      {200, 1, 100},
      {200, 2, 200},
...
TEST(MedianFilter, size_3) {
  MedianFilter<uint32_t, uint32_t, 3> input(analog_read_function);
  std::vector<InputOutput<uint32_t, uint32_t>> data = {
...
TEST(MedianFilter, size_255) {
  MedianFilter<uint32_t, uint32_t, 255> input(analog_read_function);
  std::vector<InputOutput<uint32_t, uint32_t>> data = {
      {100, 255, 100}, {200, 127, 100}, {200, 1, 200},
      {100, 127, 200}, {100, 1, 100},
  };
  RunDataTest(&input, data, setAnalogRead);
}

TEST(MedianFilter, float) {
  MedianFilter<float, float, 255> input(float_read_function);
  std::vector<InputOutput<float, float>> data = {
      {1.0, 255, 1.0}, {2.0, 127, 1.0}, {2.0, 1, 2.0},
      {1.0, 127, 2.0}, {1.0, 1, 1.0},
  };
